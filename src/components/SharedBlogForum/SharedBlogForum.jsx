...
function SharedBlogForum({ defaultTab = 'PUBLIC' }) {
    ...
    try {
      ...
      try {
        if (isAdmin) {
          ...
          // getUserCourses internally normalizes role to lowercase
      ...
      console.log('Blogs Data Normalized:', blogsData);
      console.log('Courses Data Normalized:', coursesData);
  ...
  }, [selectedCourse, currentTab, isAdmin, isStudent, isLecturer, currentUser, userRole]);
