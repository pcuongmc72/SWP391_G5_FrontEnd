...
/**
 * AuthModal — Modal Đăng nhập (email + mật khẩu) & Quên mật khẩu
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (mode === 'forgot') {
        ...
        setSuccessMsg(response?.message || 'Nếu email tồn tại, link reset đã được gửi đi.');
      } else {
    ...
    >
      <div className={styles.card}>
        ...
        <div className={styles.header}>
          <div className={styles.iconWrap} aria-hidden="true">{mode === 'login' ? '🔑' : '✉️'}</div>
          ...
          <p className={styles.subtitle}>
            {mode === 'login' 
              ...
              : 'Vui lòng nhập email để nhận liên kết khôi phục.'}
          </p>
        </div>
